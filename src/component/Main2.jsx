    ...
    return(
        ...
        <div style={{backgroundColor:"white",padding:"30px"}}>
           <div style={{color:"blue",fontSize:"12px"}}>
              <h1>Our Story</h1>
              <div style={{color:"black",fontSize:"18px",padding:"0px 20px",paddingBottom:"50px"}}>
                <p>
                    Founded with a vision to transform businesses through technology, we've grown into a trusted partner for organizations worldwide. Our journey is marked by innovation, excellence, and a commitment to delivering exceptional value to our clients
                </p>
              </div>
           </div>
